...
var connection = mysql.createConnection({
  host     : process.env.DB_HOST || '<DEJEN ALGÚN VALOR POR DEFECTO>',
  user     : process.env.DB_USER || '<DEJEN ALGÚN VALOR POR DEFECTO>',
  password : process.env.DB_PASS || '<DEJEN ALGÚN VALOR POR DEFECTO>',
  database : process.env.DB_NAME || '<DEJEN ALGÚN VALOR POR DEFECTO>',
